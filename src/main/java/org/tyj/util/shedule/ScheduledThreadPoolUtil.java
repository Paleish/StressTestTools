...
public class ScheduledThreadPoolUtil {
    ...
    private static ScheduledThreadPoolExecutor stpe = new ScheduledThreadPoolExecutor(5000, new RejectPolicy());
    ...
    public boolean removeTask(Runnable runTask) {
        return stpe.remove(runTask);
    }
